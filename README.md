...
- You can pack your textures into .askin file and send in to your friend. Press "Add new skin from folder" button and select "...\Audiosurf\engine\textures" folder. Programm will offer you to name new skin, if you deny this offer, skin will be automatically named as folder that you select.
